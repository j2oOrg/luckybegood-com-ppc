  ...
  <div class="shell-wrap-z4m2">
    <div class="notice-box-a9r0">
      ...
      <h3 class="subheading-c8q2">1. Purpose</h3>
        <p class="section-sub-p0c6">luckybegood provides free-to-play, social game-style experiences for entertainment, previews, and campaign review. No deposits, wagers, or prizes are offered.</p>
