...
SITE_TITLE=${WP_SITE_TITLE:-${SITE_TITLE:-luckybegood}}
...
SITE_URL=${WP_SITE_URL:-${SITE_URL:-https://luckybegood.com}}
...
# Activate the bundled luckybegood theme by default (idempotent).
if wp --path=/var/www/html --allow-root theme is-installed luckybegood; then
    wp --path=/var/www/html --allow-root theme activate luckybegood
fi
